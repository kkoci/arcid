...
export default function RegisterAgent({ onRegister, prototypeMode = true }) {
    ...
    <section className="rounded-lg border border-arc-panel bg-arc-panel/60 backdrop-blur p-4 flex flex-col gap-3">
      ...
      <p className="text-sm text-arc-dim">
        {prototypeMode
          ...
          : "Generates a DCAP attestation quote inside an Intel TDX enclave, submits to the ArcID Registry on Arc, provisions a Circle Programmable Wallet, and binds it on-chain."
        }
      </p>
